marcadorModulo = (function () {
  ...
  function mostrarMiMarcador (ubicacion) {
    ...
    // Borro el punto ingresado previamente del mapa
    if(miMarcador.length != 0){
      miMarcador[0].setMap(null);
      miMarcador = [];
    }

    //Borro los antiguos lugares proximos
